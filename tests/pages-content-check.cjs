...
const files = ['index.html', 'js/chat.js', 'js/helper-data.js', 'js/memory-preferences.js', 'js/prompt-cache.js', 'js/story-revision-state.js', 'js/world-modules.js', 'js/world-state-hook.js', 'js/player-settings.js', 'css/memory-preferences.css'];
